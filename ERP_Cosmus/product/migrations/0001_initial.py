    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Items_name', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='godown_rawmaterials', to='product.item_color_shade')),
                ('godown_name', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='godown_names', to='product.godown_raw_material')),
            ],
        ),
        migrations.CreateModel(
            name='Item_Creation',
