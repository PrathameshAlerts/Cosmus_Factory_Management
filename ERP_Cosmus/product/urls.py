...
urlpatterns = [
    ...
    path('finishedgoodsgodownproductrefvendorwisereport/<int:vendor_id>/<int:ref_no>', views.finished_goods_vendor_model_wise_report, name = 'finished-goods-godown-product-ref-vendor-wise-report'),
