...
class cutting_room_form(CompanyBaseForm):  
    class Meta:
        model = cutting_room
        fields = ['cutting_room_name','company'] 
...
class factory_employee_form(CompanyBaseForm):  
    class Meta:
        model = factory_employee
        fields = ['factory_emp_name','cutting_room_id', 'company'] 
