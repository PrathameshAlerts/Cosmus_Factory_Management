...
purchase_order_cutting_approval_formset = inlineformset_factory(purchase_order_raw_material_cutting,purchase_order_to_product_cutting,fields=['product_color','product_sku','cutting_quantity','approved_pcs','balance_pcs','approved_pcs_diffrence'], extra=0, can_delete=False)
