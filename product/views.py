...
def qc_approved_model_wise_report(request,ref_id):
    ...
    if ref_id:
        ...
        for record in l_w_in_instances:
            ...
            # without dict() -> [<QuerySet [(40051011046, 500), (40051021046, 500)]>]
            # with dict() -> [{40051011046: 500}]
            # with values('product_sku','return_pcs') ->  [{'product_sku': 40051041046, 'return_pcs': 100}]
            # with values_list('product_sku','return_pcs') - > {40051041046: 100}
